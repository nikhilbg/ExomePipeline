rule delly_somatic:
    ...
    output: del="delly_out/{group[1]}.del.bcf",
            ins="delly_out/{group[1]}.ins.bcf",
            dup="delly_out/{group[1]}.dup.bcf",
            tra="delly_out/{group[1]}.tra.bcf",
            inv="delly_out/{group[1]}.inv.bcf"
