rule mutect:
       ...
       params: mutect=config['bin']['MUTECT'],gatk=config['bin']['GATK'],genome=config['references']['MUTECTGENOME'],cosmic=config['references']['MUTECTCOSMIC'],snp=config['references']['MUTECTSNP'],rname="pl:mutect"
       shell:  """
